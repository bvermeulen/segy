...
with segyio.open(file_min_phase, ignore_geometry=True) as segy_obj:
        trace_samples = segy_obj.trace[3]
...
with segyio.open(file_zero_phase, ignore_geometry=True) as segy_obj:
    trace_samples = segy_obj.trace[3]
